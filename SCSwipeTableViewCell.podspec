#
#  Be sure to run `pod spec lint SCSwipeTableViewCell.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/MonkeyS914/SCSwipeTableViewCell"
  ...
  s.source       = { :git => "https://github.com/MonkeyS914/SCSwipeTableViewCell.git", :tag => "1.0.0" }
  ...
  s.source_files  = "SCSwipeTableViewCell/**/*.{h,m}"
